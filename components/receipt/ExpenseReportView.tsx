              ...
              <div className="bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-md">
                ...
                <div className="p-4 border-b border-gray-200">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="inline-flex items-center px-3 py-1 bg-orange-100 text-orange-600 text-xs font-semibold rounded-full">
                      Scanning...
                    </span>
                  ...
                  <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                    {images.map((image, index) => (
                      <div key={index} className="flex-shrink-0 w-32">
                        <div className="relative w-32 h-40 rounded-xl overflow-hidden bg-gray-100 border border-gray-300">
                          <Image
                            src={image}
                            alt={`Receipt ${index + 1}`}
                            fill
                        ...
                        <div className="mt-2">
                          <p className="text-xs text-gray-600 text-center">{currentDate} • Fuel</p>
                          <p className="text-xs text-gray-400 mt-1 text-center font-mono">Scanning...</p>

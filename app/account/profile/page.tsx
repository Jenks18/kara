...
const AVATAR_OPTIONS = [
  ...
  { emoji: '💼', color: 'from-indigo-600 to-indigo-700', label: 'Business' },
  { emoji: '🎯', color: 'from-rose-600 to-rose-700', label: 'Target' },
  { emoji: '📊', color: 'from-emerald-600 to-emerald-700', label: 'Analytics' },
  { emoji: '🏢', color: 'from-slate-700 to-slate-800', label: 'Corporate' },
  { emoji: '💡', color: 'from-amber-600 to-amber-700', label: 'Innovation' },
  { emoji: '🎓', color: 'from-indigo-700 to-indigo-800', label: 'Education' },
  { emoji: '⚡', color: 'from-yellow-600 to-yellow-700', label: 'Energy' },
  { emoji: '🔧', color: 'from-gray-700 to-gray-800', label: 'Tools' },
  { emoji: '📈', color: 'from-green-700 to-green-800', label: 'Growth' },
  { emoji: '🌟', color: 'from-amber-500 to-amber-600', label: 'Star' },
  { emoji: '🎨', color: 'from-purple-700 to-purple-800', label: 'Creative' },
  { emoji: '🚀', color: 'from-blue-700 to-blue-800', label: 'Launch' },
  { emoji: '💻', color: 'from-cyan-700 to-cyan-800', label: 'Tech' },
  { emoji: '📱', color: 'from-teal-700 to-teal-800', label: 'Mobile' },
  { emoji: '🌐', color: 'from-sky-600 to-sky-700', label: 'Global' },
  { emoji: '🔒', color: 'from-red-700 to-red-800', label: 'Security' },
  { emoji: '✅', color: 'from-emerald-700 to-emerald-800', label: 'Success' },
  { emoji: '⭐', color: 'from-orange-600 to-orange-700', label: 'Premium' },
  { emoji: '🎯', color: 'from-pink-700 to-pink-800', label: 'Focus' },
  { emoji: '📍', color: 'from-red-600 to-red-700', label: 'Location' },
  { emoji: '🏆', color: 'from-yellow-700 to-yellow-800', label: 'Achievement' },
  { emoji: '💎', color: 'from-cyan-600 to-cyan-700', label: 'Diamond' },
  { emoji: '🎪', color: 'from-fuchsia-600 to-fuchsia-700', label: 'Event' },
  { emoji: '🌈', color: 'from-violet-600 to-violet-700', label: 'Diversity' },
  { emoji: '⚙️', color: 'from-slate-600 to-slate-700', label: 'Settings' },
  { emoji: '📋', color: 'from-stone-600 to-stone-700', label: 'Tasks' },
  { emoji: '🔔', color: 'from-orange-700 to-orange-800', label: 'Notifications' },
  { emoji: '🌍', color: 'from-green-700 to-green-800', label: 'World' },
  { emoji: '⏱️', color: 'from-blue-600 to-blue-700', label: 'Time' },
]

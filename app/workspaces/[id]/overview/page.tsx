      ...
      <div className="px-4 py-6 max-w-md mx-auto space-y-6">
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            <button className="absolute bottom-0 right-0 w-8 h-8 rounded-full bg-white border border-emerald-200 flex items-center justify-center active:scale-95 transition-transform shadow-sm">
        ...
        <div className="space-y-4">
          {/* Workspace name */}
          <button className="w-full bg-white rounded-xl border border-emerald-200 p-4 hover:bg-emerald-50 transition-colors shadow-sm relative">
          ...
          <button className="w-full bg-white rounded-xl border border-emerald-200 p-4 hover:bg-emerald-50 transition-colors relative shadow-sm">
            <div className="text-left space-y-1">
              ...
              <div className="text-gray-900">{workspace.address || ''}</div>
            </div>
            <ChevronRight size={20} className="text-gray-600 absolute right-6 top-1/2 -translate-y-1/2" />
          </button>
          ...
          <button className="w-full bg-white rounded-xl border border-emerald-200 p-4 hover:bg-emerald-50 transition-colors relative shadow-sm">
            <div className="text-left space-y-1">
              ...
              <div className="text-gray-900 font-semibold">{workspace.plan_type || 'Collect'}</div>
            </div>
            <ChevronRight size={20} className="text-gray-600 absolute right-6 top-1/2 -translate-y-1/2" />
          </button>
        </div>

    ...
    <div className="min-h-screen bg-[#121f16]">
      ...
      <div className="sticky top-0 z-30 bg-[#121f16] border-b border-gray-800">
        <div className="px-4 py-4 max-w-md mx-auto flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-white flex-1">Workflows</h1>
        </div>
      </div>
      ...
      <div className="px-4 py-6 max-w-md mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <h2 className="text-white text-lg font-semibold">Submissions</h2>
          ...
          <div className="flex items-start justify-between bg-dark-200 rounded-xl border border-gray-800 p-4">
            ...
            <button
              ...
              className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors flex-shrink-0 ${
                submissionsEnabled ? 'bg-primary' : 'bg-gray-600'
              }`}
            >
              <span
          ...
          <button className="w-full bg-dark-200 rounded-xl border border-gray-800 p-4 active:bg-dark-100 transition-colors relative">
            <div className="text-left space-y-1">
              ...
              <div className="text-white font-medium">Manually</div>
            </div>
        ...
        <div className="space-y-4 pt-4">
          <h2 className="text-white text-lg font-semibold">Approvals</h2>
          ...
          <div className="flex items-start justify-between bg-dark-200 rounded-xl border border-gray-800 p-4">
            ...
            <button
              ...
              className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors flex-shrink-0 ${
                approvalsEnabled ? 'bg-primary' : 'bg-gray-600'
              }`}
            >
              <span
                className={`inline-block h-6 w-6 transform rounded-full bg-white transition-transform ${
          ...
          <div className="bg-dark-200 rounded-xl border border-gray-800 p-4 space-y-3">
            ...
            <button className="w-full bg-dark-300 rounded-lg border border-gray-700 p-3 active:bg-dark-100 transition-colors relative">
              <div className="flex items-center gap-3">
                <Users size={20} className="text-gray-400" />
                <div className="text-left flex-1">
                  <div className="text-xs text-gray-400">Expenses from</div>
            ...
            <button className="w-full bg-dark-300 rounded-lg border border-gray-700 p-3 active:bg-dark-100 transition-colors relative">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left flex-1">
                  ...
                  <div className="text-white font-medium">{user?.emailAddresses[0]?.emailAddress || 'Owner'}</div>
                </div>
                <ChevronRight size={20} className="text-gray-400" />
              </div>
            </button>
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="flex items-start justify-between bg-dark-200 rounded-xl border border-gray-800 p-4">
            ...
            <button
              ...
              className={`relative inline-flex h-8 w-14 items-center rounded-full transition-colors flex-shrink-0 ${
                paymentsEnabled ? 'bg-primary' : 'bg-gray-600'
              }`}
            >
              <span
                className={`inline-block h-6 w-6 transform rounded-full bg-white transition-transform ${
